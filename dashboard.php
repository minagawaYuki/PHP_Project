...
<body>
        ...
        <div class="create-playlist">
            ...
            <form method="post">
                ...
                if(isset($_POST['btnCreate'])){		
                    ...
                    $sql1 ="Insert into tbluserplaylist(userid, playlistname, songs) values('".$username."','".$playlistname."','".$songname."')";
    ...
    <div class="registered-users-table" style="margin-top: 105px;">
        ...
        <?php
            ...
            $resultset = $mysqli->query("SELECT * from tbluserplaylist") or die ($mysqli->error);
        ?>
        <table id="tblStudentRecords" class="table" cellspacing="0" width="100%" style="text-align: center;">
            ...
            <tbody><?php
                    ...
                    <tr>
                        ...
                        <td>
                            <?php echo "<a href='userplaylist.php' style='padding-right: 5px;'>VIEW</a>";
